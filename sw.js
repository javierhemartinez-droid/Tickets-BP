...
const CACHE_NAME = 'entradas-shell-v3';
...
self.addEventListener('fetch', (event) => {
  ...
  if (isHtmlOrNav) {
    // NETWORK-FIRST + no-store: ignora también la caché HTTP del navegador
    // (GitHub Pages manda cache-control por unos minutos, y eso alcanzaba
    // para servir una versión vieja aunque el SW ya pidiera red primero).
    event.respondWith(
